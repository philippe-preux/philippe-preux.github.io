...
//      if (i == false) {
        // S'il est caché (la verif n'est qu'une securité),
        // on le rend visible.
        GetId("curseur").style.visibility = "visible"; 
        // Cette fonction qui suit est à améliorer, 
...
//      }
    ...
    // dès que la souris bouge, on appelle la fonction move()
...
<img SRC="../img/ptBleu.png" width="10" height="10">
  <a href="../papiers/exposeRL.pdf">Un
    exposé de présentation sur l'apprentissage par renforcement</a>
    présenté aux <a href="http://lil.univ-littoral.fr/~fonlupt/JET8/">JET</a>
    (fin 2002).
...
<img SRC="../img/ptOrange.png" width="10" height="10"> 
  <a href="../papiers/man.pdf">Machines à noyau&nbsp;: une courte introduction (ou «&nbsp;SVM décryptées&nbsp;», ou «&nbsp;SVMs pour les nuls&nbsp;»)</a>
</dt>
<dt>
<img SRC="../img/ptOrange.png" width="10" height="10"> 
  <a href="http://www.grappa.univ-lille3.fr/~ppreux/fouille/big.data/slides"><font size="-1">Data</font> Data <font size="+1">Data</font> <font size="+2">Data</font></a>, École Centrale de Lille, Déc. 2012
</dt>
<dt>
<img SRC="../img/ptBleuClair.png" width="10" height="10"> 
  ...
  le demander</i>, (only available in french) Seconde édition (avr. 95)
...
<img SRC="../img/fda.jpg" width="20" height="30" />
  ...
  d'intérêts fonctionnelles (<a
  href="../papiers/JDS2011.pdf">draft</a>),
  in <i>Proc. <a
  href="http://jds2011.tn.refer.org/">43<sup>e</sup> Journées de
...
<img SRC="../img/ptRouge.png" width="10" height="10" 
  ...
  Affichage de publicités sur des portails <i>web</i>,
  in <i>Proc. <a
...
<img SRC="../img/ptBleu.png" width="10" height="10" onmouseover = "montre('reinforcement learning');" onmouseout = "cache();" />
  ...
  Prise de décision séquentielle</a>,
...
<img SRC="../img/ptBleu.png" width="10" height="10" onmouseover = "montre('reinforcement learning');" onmouseout = "cache();" />
  ...
  <a href="http://carlit.toulouse.inra.fr/JFPDA/">Journées
    Francophones Planification, Décision, Apprentissage</a>,
...
<dt id="sims2003">
<img SRC="../img/ptVert.png" width="10" height="10"  onmouseover = "montre('virtual laboratories');" onmouseout = "cache();" />  R. Duboz, É. Ramat, Ph. Preux,
...
<dt id="m2m2003">
<img SRC="../img/ptVert.png" width="10" height="10"  onmouseover = "montre('virtual laboratories');" onmouseout = "cache();" />  R. Duboz, F. Amblard, É. Ramat, G. Deffuant, Ph. Preux,
...
<dt id="simpat2002">
<img SRC="../img/ptVert.png" width="10" height="10"  onmouseover = "montre('virtual laboratories');" onmouseout = "cache();" />  É. Ramat, Ph. Preux,
...
<img SRC="../img/ptBleu.png" width="10" height="10" onmouseover = "montre('reinforcement learning');" onmouseout = "cache();" />
  ...
  <i>Société de biomécanique, Archives of physiology and
...
<dt id="mosim2001">
<img SRC="../img/ptVert.png" width="10" height="10"  onmouseover = "montre('virtual laboratories');" onmouseout = "cache();" />  É. Ramat, Ph. Preux, Virtual Laboratory Environment
  (VLE) : un environnement multi-agents et objets pour la modélisation
  et la simulation de systèmes complexes, <a href="http://www.utt.fr/mosim01/">MOSIM</a>
...
<img SRC="../img/ptBleu.png" width="10" height="10" onmouseover = "montre('reinforcement learning');" onmouseout = "cache();" />
  ...
  et sciences de l'ingénieur</a>, Rennes, France, Septembre 2000
...
<dt>
  <img SRC="../img/ptRose.png" width="10" height="10" onmouseover = "montre('genetic algorithms, combinatorial optimization');" onmouseout = "cache();" /> 
  Ph. Preux, <i>Réflexions sur quelques systèmes complexes et leur
   dynamique</i>, mémoire d'habilitation à diriger les recherches, 
...
<img SRC="../img/ptVert.png" width="10" height="10" /> 
  ...
  du copépode,
  <a href="http://wwwlisc.clermont.cemagref.fr/SMAGET.htm">Modèles
...
<img SRC="../img/ptRose.png" width="10" height="10" onmouseover = "montre('genetic algorithms, combinatorial optimization');" onmouseout = "cache();" /> 
  ...
  la coopération de métaheuristiques parallèles, <i>Calculateurs
  Parallèles, Réseaux et Systèmes Répartis</i>, <b>10</b>(2),
  211-223, Avril 1998
...
<a href="http://www.univ-lille1.fr/">Université de Lille 1</a>. 
...
<dt>
<img SRC="../img/ptJaune.png" width="10" height="10" onmouseover = "montre('vector pipeline supercomputers');" onmouseout = "cache();" /> 
Ph. Preux, MAD : une machine virtuelle vectorielle - Conséquences sur les architectures vectorielles, PhD dissertation, Lille, Jan 1991</dt>
